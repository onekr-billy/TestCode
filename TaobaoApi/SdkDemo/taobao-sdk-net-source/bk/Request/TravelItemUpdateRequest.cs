...
{
    /// <summary>
    /// TOP API: taobao.travel.item.update
    /// </summary>
    public class TravelItemUpdateRequest : ITopUploadRequest<TravelItemUpdateResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// 玩法描述，字数不能超过1500。当play_id不设置时，表示卖家自定义玩法描述。注意：play_id和play_desc必须填写一项。
        /// </summary>
